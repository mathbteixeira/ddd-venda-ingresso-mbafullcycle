...
@Getter
public class SpotReservationChanged implements IDomainEvent {
    ...
    public SpotReservationChanged(EventSpot.EventSpotId aggregateId, Instant reservationDate, Customer.CustomerId customerId) {
